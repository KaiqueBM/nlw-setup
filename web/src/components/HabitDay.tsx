...
export function HabitDay({ defaultCompleted = 0, amount = 0, date }: HabitDayProps) {
    ...
    const completedPercentage = amount > 0 ? Math.round(completed / amount * 100) : 0 // 2 / 6 * 100 -> 33,3% de 100%

    const dayAndMonth = dayjs(date).format('DD/MM') //Formato da data
